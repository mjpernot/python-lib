...
coverage run -a --source=gen_libs test/unit/gen_libs/convert_bytes.py
...
coverage run -a --source=gen_libs test/unit/gen_libs/du_cmd.py
...
coverage run -a --source=gen_libs test/unit/gen_libs/is_file_deletable.py
