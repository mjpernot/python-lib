...
"""Program:  keycaseinsensitivedict_get.py

    Description:  Unit testing of keycaseinsensitivedict.get in
        gen_class.py.

    Usage:
        test/unit/gen_class/keycaseinsensitivedict_get.py
...
class UnitTest(unittest.TestCase):
    ...
    def test_lowercase(self):
        ...
        self.assertEqual(self.cidict.get("this"), self.results)
    ...
    def test_numeric(self):
        ...
        self.assertEqual(self.cidict.get(4), self.results2)
