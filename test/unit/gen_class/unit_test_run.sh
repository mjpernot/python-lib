...
/usr/bin/python2 ./test/unit/gen_class/dict_out.py
...
/usr/bin/python2 ./test/unit/gen_class/mail2_init.py
/usr/bin/python2 ./test/unit/gen_class/mail2_add_attachment.py
/usr/bin/python2 ./test/unit/gen_class/mail2_add_text.py
/usr/bin/python2 ./test/unit/gen_class/mail2_send_mail.py
